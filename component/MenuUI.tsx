            ...
            <div className="fixed top-0 left-0 flex justify-between w-screen h-20 p-5 bg-blue-950 z-40 text-white">
                ...
                <div className="flex justify-end mx-5 items-center flex-1 lg:gap-3 ">
                    ...
                    <div className="bg-blue-700  mx-5  overflow-hidden rounded-full flex flex-row items-center justify-center">
                        ...
                        <input type="text" className="bg-blue-700 p-1 px-2 w-sm rounded-full focus:outline-0 focus:ring-0 border-0  md:block hidden"/>
                    </div>
                    {/* Condition Render */}
                    {isSignedIn ? (
                        <>
                            ...
                            <ul className={`absolute right-5 top-24 bg-blue-700 flex flex-col overflow-hidden rounded-2xl ${State.UserMenu ? 'block' : 'hidden'}`}>
                                ...
                                <Link href={'/settings'} className="text-lg p-3 hover:bg-blue-500 bg-transparent transition-colors"><i className="fa-solid fa-gear"></i> Pengaturan</Link>
