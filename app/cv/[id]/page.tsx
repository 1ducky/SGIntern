        ...
        <>
            ...
            <div className="w-full md:w-1/3 bg-[#d1e1e9] p-8 flex flex-col items-center">
                ...
                <div className="w-full text-[#2c4c58]">
                    <h2 className="text-xl font-bold tracking-widest border-b-2 border-[#2c4c58] mb-4 pb-1 uppercase">Keahlian</h2>
                    <ul className="list-disc list-outside ml-5 space-y-2 text-sm">
                        <li>Komunikasi yang baik dalam bahasa Indonesia.</li>
                        <li>Kemampuan berbicara dan menulis dalam bahasa Inggris yang baik.</li>
                        <li>Pemahaman tentang layanan pelanggan yang baik.</li>
                        <li>Penguasaan Microsoft Office (Word, Excel, PowerPoint).</li>
                        <li>Keahlian dalam menggunakan perangkat lunak CRM.</li>
                        <li>Keterampilan multitasking yang baik.</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="w-full md:w-2/3 p-10 bg-white text-gray-700">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-sm text-gray-600 text-justify leading-relaxed">
                        {description[userData?.jurusan?.toLowerCase()]}
                    </p>
                </div>
                ...
                <div>
                    <h2 className="text-xl font-bold tracking-[0.3em] text-[#1e3a4d] border-b-2 border-gray-200 mb-6 pb-1 uppercase">Riwayat Pendidikan</h2>
                    
                    <div>
                        {userData?.pendidikan?.trim().split('+').map((item,i) => (
                            <h3 key={i}  className="font-bold text-md text-[#1e3a4d] uppercase">{item}</h3>
                        ))}
